...
public class TensorflowGRUConfig extends TensorflowRecurrentConfig {
    ...
    public TensorflowGRUConfig(
        ...
        super(MLConstants.GRU, new TensorflowConfigCommon(steps, lr, inputdropout, dropout, normalize, batchnormalize, regularize, batchsize, loss, optimizer, activation, lastactivation), layers, hidden, slide);
    }
