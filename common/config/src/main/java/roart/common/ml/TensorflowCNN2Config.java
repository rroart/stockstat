...
public class TensorflowCNN2Config extends TensorflowPreFeedConfig {
    ...
    public TensorflowCNN2Config(
        ...
        super(MLConstants.CNN2, new TensorflowConfigCommon(steps, lr, inputdropout, dropout, normalize, batchnormalize, regularize, batchsize, loss, optimizer, activation, lastactivation, binary), convlayers, layers, hidden);
    ...
    public TensorflowCNN2Config(TensorflowCNN2Config config) {
        super(MLConstants.CNN2, new TensorflowConfigCommon(config.tensorflowConfigCommon), config.convlayers, config.layers, config.hidden);
