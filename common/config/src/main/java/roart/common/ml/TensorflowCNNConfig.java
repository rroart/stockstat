...
public class TensorflowCNNConfig extends TensorflowPreFeedConfig {
    ...
    public TensorflowCNNConfig(
        ...
        super(MLConstants.CNN, new TensorflowConfigCommon(steps, lr, inputdropout, dropout, normalize, batchnormalize, regularize, batchsize, loss, optimizer, activation, lastactivation, binary), convlayers, layers, hidden);
