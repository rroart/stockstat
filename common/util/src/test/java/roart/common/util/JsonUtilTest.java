...
public class JsonUtilTest {
    ...
    public void test() {
        ...
        // TODO Arr arr2 = JsonUtil.convert(ser, Arr.class, mapper);
        // TODO System.out.println("" + arr2.arra[0][0]);
        Map<String, MyObject> map = new HashMap<>();
        map.put("1", arr);
        ser = JsonUtil.convert(map, mapper);
        System.out.println("ser2 " + ser);
        // TODO Map<String, MyObject> map2 = JsonUtil.convert(ser, Map.class, mapper);
