...
public abstract class FileSystemAbstractController implements CommandLineRunner {
    ...
    protected abstract FileSystemOperations createOperations(String nodename, String configid, ConfigData nodeConf);

    private FileSystemOperations getOperations(String nodename, String configid, ConfigData nodeConf) {
    ...
    public FileSystemConstructorResult processConstructor(@RequestBody FileSystemConstructorParam param)
        ...
        String error = null;
        try {
            FileSystemOperations operations = getOperations(param.nodename, param.configid, param.configData);
        } catch (Exception e) {
