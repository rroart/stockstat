...
def learntestclassify(classify_x, cf = 'pytorchMLPConfig', size = None, classes = None, train_x = None, train_y = None, test_x = None, test_y = None, steps = None, zero = True, classify = True, take = None):
...
def learntestclassifynotest(classify_x, cf = 'pytorchMLPConfig', size = None, classes = None, train_x = None, train_y = None, steps = None, zero = True, classify = True, take = None):
