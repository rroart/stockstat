...
def learntestclassifynotest(classify_x, cf = 'pytorchMLPConfig', size = None, classes = None, train_x = None, train_y = None, steps = None, zero = True, classify = True, take = None, override = None, binary = False):
    neuralnetcommand = { 'mldynamic' : True, 'mlclassify' : False, 'mllearn' : True }
    return learntestclassify_inner(cf = cf, steps = steps, size = size, classes = classes, take = take, zero = zero, train_x = train_x, train_y = train_y, classify_x = classify_x, classify = classify, neuralnetcommand = neuralnetcommand, override = override, binary = binary)
