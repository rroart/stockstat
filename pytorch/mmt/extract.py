...
def extract(name, in_dir, out_dir, resolution):
    ...
    # Encode the score
    notes = mmt.representation.extract_notes(music, resolution)
    ...
    mmt.representation.save_csv_notes((out_dir / name).with_suffix(".csv"), notes)
...
def main(args):
    ...
    mmt.utils.save_txt(out_filename, extracted_names)
