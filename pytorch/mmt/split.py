...
def main(dir, args):
    ...
    mmt.utils.save_txt(args.out_dir / "train-names.txt", train_names)
    logging.info(f"Collected {len(train_names)} files for training.")

    mmt.utils.save_txt(args.out_dir / "valid-names.txt", valid_names)
    logging.info(f"Collected {len(valid_names)} files for validation.")

    mmt.utils.save_txt(args.out_dir / "test-names.txt", test_names)
