...
public class MACDRecommendSimple extends RecommendMACD {
    ...
    public  List<String> getBuyList() {
        ...
        buyList.add(ConfigConstants.AGGREGATORSINDICATORRECOMMENDERSIMPLEMACDBUYWEIGHTMOMENTUM);
        buyList.add(ConfigConstants.AGGREGATORSINDICATORRECOMMENDERSIMPLEMACDBUYWEIGHTMOMENTUMDELTA);
        return buyList;
    }
    ...
    public  List<String> getSellList() {
        ...
        sellList.add(ConfigConstants.AGGREGATORSINDICATORRECOMMENDERSIMPLEMACDSELLWEIGHTMOMENTUM);
        sellList.add(ConfigConstants.AGGREGATORSINDICATORRECOMMENDERSIMPLEMACDSELLWEIGHTMOMENTUMDELTA);
        return sellList;
    }
