...
public class GraphIndicatorSTOCH extends GraphIndicator {
    ...
    public GraphIndicatorSTOCH(MyConfig conf, String string, Map<String, MarketData> marketdatamap, Map<String, PeriodData> periodDataMap, String title) {
        super(conf, string);
    ...
    public void getResult(List<ResultItem> retlist, Set<Pair<String, String>> ids, GUISize guiSize) {
        try {
            ...
            for (Pair id : ids) {
                ...
                DefaultCategoryDataset dataset = tu.getSTOCHChart(days, market, stockid, ids, marketdatamap, perioddata, periodText);
                if (dataset != null) {
