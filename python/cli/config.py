...
TENSORFLOWCNN2CONFIG = { 'name' : 'cnn2', 'stride' : 1, 'kernelsize' : 3, 'maxpool': 4, **TENSORFLOWCOMMONPREFEED, **TENSORFLOWCOMMON }
...
PYTORCHCNN2CONFIG = { 'name' : 'cnn2', 'stride' : 1, 'kernelsize' : 3, 'maxpool': 4, **PYTORCHCOMMONPREFEED, **PYTORCHCOMMON }
