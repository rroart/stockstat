...
def learntestclassify(classify_x, cf = 'tensorflowMLPConfig', size = None, classes = None, train_x = None, train_y = None, test_x = None, test_y = None, steps = None, zero = True, classify = True, take = None, override = None):
