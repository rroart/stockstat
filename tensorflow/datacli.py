...
def learntest(cf = 'tensorflowMLPConfig', size = None, classes = None, train_x = None, train_y = None, test_x = None, test_y = None, classifyarray = None, steps = None, zero = True, classify = True, take = None, binary = False):
...
def classify(classify_x, path = None, cf = 'tensorflowMLPConfig', take = None, size = None, train_x = None, train_y = None, zero = True, classify = True, classes = None, binary = False):
