...
TENSORFLOWDNNCONFIG = { 'name' : 'dnn', 'steps' : 1000, 'lr' : 0.001, 'dropout' : 0.5, 'normalize' : True, 'batchnormalize' : True, 'regularize' : True, 'hidden' : 100, 'layers': 2 }
TENSORFLOWLICCONFIG = { 'name' : 'lic', 'steps' : 1000, 'lr' : 0.001, 'dropout' : 0.5, 'normalize' : True, 'batchnormalize' : True, 'regularize' : True }
TENSORFLOWMLPCONFIG = { 'name' : 'mlp', 'steps' : 1000, 'lr' : 0.001, 'dropout' : 0.5, 'normalize' : True, 'batchnormalize' : True, 'regularize' : True, 'hidden' : 100, 'layers' : 1 }
TENSORFLOWRNNCONFIG = { 'name' : 'rnn', 'steps' : 1000, 'lr' : 0.001, 'dropout' : 0.5, 'normalize' : True, 'batchnormalize' : True, 'regularize' : True, 'hidden' : 100, 'layers' : 2, 'dropoutin' : 0 }
TENSORFLOWCNNCONFIG = { 'name' : 'cnn', 'steps' : 1000, 'lr' : 0.001, 'dropout' : 0.5, 'normalize' : True, 'batchnormalize' : True, 'regularize' : True, 'stride' : 1, 'kernelsize' : 4 }
TENSORFLOWCNN2CONFIG = { 'name' : 'cnn2', 'steps' : 1000, 'lr' : 0.001, 'dropout' : 0.5, 'normalize' : True, 'batchnormalize' : True, 'regularize' : True, 'stride' : 1, 'kernelsize' : 3, 'maxpool': 4, 'dropout1': 0.25, 'dropout2' : 0.5 }
TENSORFLOWLSTMCONFIG = { 'name' : 'lstm', 'steps' : 1000, 'lr' : 0.001, 'dropout' : 0.5, 'normalize' : True, 'batchnormalize' : True, 'regularize' : True, 'hidden' : 15, 'layers' : 1, 'dropout' : 0, 'dropoutin' : 0 }
TENSORFLOWGRUCONFIG = { 'name' : 'gru', 'steps' : 1000, 'lr' : 0.001, 'dropout' : 0.5, 'normalize' : True, 'batchnormalize' : True, 'regularize' : True, 'hidden' : 100, 'layers' : 2, 'dropout' : 0, 'dropoutin' : 0 }
TENSORFLOWLIRCONFIG = { 'name' : 'lir', 'steps' : 1000, 'lr' : 0.001, 'dropout' : 0.5, 'normalize' : True, 'batchnormalize' : True, 'regularize' : True }
