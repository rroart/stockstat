...
TENSORFLOWMLPCONFIG = { 'name' : 'mlp', 'steps' : 1000, 'hidden' : 100, 'layers' : 1, 'lr' : 0.001 }
...
TENSORFLOWLSTMCONFIG = { 'name' : 'lstm', 'steps' : 1000, 'hidden' : 15, 'layers' : 1, 'lr' : 0.001, 'dropout' : 0, 'dropoutin' : 0 }
