...
public class Memory implements Serializable {
    ...
    return HibernateUtil.convert(HibernateUtil.currentSession().createQuery("from Memory").list(), Memory.class);
}

    @Transient
    public static List<Memory> getAll(String mymarket) throws Exception {
    return (List<Memory>) HibernateUtil.convert(HibernateUtil.currentSession().createQuery("from Memory where market = :mymarket").setParameter("mymarket",  mymarket).list(), Memory.class);
}
