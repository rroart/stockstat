...
public class Memory implements Serializable {
    ...
    return HibernateUtil.convert(HibernateUtil.currentSession().createQuery("from Memory where market = :mymarket").setParameter("mymarket",  mymarket).list(), Memory.class);
}
