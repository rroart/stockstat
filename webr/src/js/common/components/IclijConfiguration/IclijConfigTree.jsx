...
import IclijTreeView from './IclijTreeView';

class IclijConfigTree extends PureComponent {
  constructor(props) {
    super(props);
  }
...
/*
  ...
  */
  ...
  return(
  <li key={mykey}>
  <IclijTreeView {...this.props} map={value}/>
  </li>
  )
  }
  ...
  return(
  <li>
  <IclijTreeView {...this.props} map={map}/>	
  </li>
  )
  }
  ...
  render() {
    ...
    //console.log(main);
    const config = main && main.iconfig ? main.iconfig : null;
  //console.log(config);
...
export default IclijConfigTree;
