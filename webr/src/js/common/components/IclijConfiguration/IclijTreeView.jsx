...
class IclijTreeView extends PureComponent {
  constructor(props) {
    super(props);
  }
  ...
  return (<input type="text" onChange={e => this.handleChange(e, key, this.props)} defaultValue={value}/>);
    ...
    props.seticonfigvaluemap([ key, event.target.checked ]);
  }
    ...
    console.log(props);
    //this.props.setmarket({market: event.value});
    props.seticonfigvaluemap([ key, event.target.value ]);
