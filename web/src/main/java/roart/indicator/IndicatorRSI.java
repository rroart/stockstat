...
public class IndicatorRSI extends Indicator {
    ...
    public IndicatorRSI(ControlService controlService, String string, Map<String, MarketData> marketdatamap, Map<String, PeriodData> periodDataMap, Map<String, Integer>[] periodmap, String title) {
    ...
    public Object getResultItem(Stock stock) {
        ...
        double rsi = tu.getRSI2(controlService.getDays(), market, id, ids, marketdatamap, perioddata, periodstr);
        return rsi;
    }
