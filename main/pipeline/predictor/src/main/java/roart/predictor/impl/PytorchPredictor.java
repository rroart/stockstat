...
public abstract class PytorchPredictor extends Predictor {
    public PytorchPredictor(IclijConfig conf, String string, String title, int category, NeuralNetCommand neuralnetcommand, PipelineData[] datareaders, Inmemory inmemory) {
