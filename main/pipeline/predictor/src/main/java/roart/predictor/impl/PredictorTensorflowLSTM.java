...
public class PredictorTensorflowLSTM extends TensorflowPredictor {
    ...
    public PredictorTensorflowLSTM(IclijConfig conf, String string, String title, int category, SerialPipeline datareaders, NeuralNetCommand neuralnetcommand, Inmemory inmemory) throws Exception {
