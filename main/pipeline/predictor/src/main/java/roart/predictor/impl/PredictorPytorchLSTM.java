...
public class PredictorPytorchLSTM extends PytorchPredictor {
    ...
    public PredictorPytorchLSTM(IclijConfig conf, String string, String title, int category, PipelineData[] datareaders, NeuralNetCommand neuralnetcommand, Inmemory inmemory) throws Exception {
