...
public class PredictorTensorflowRNN extends TensorflowPredictor {
    ...
    public PredictorTensorflowRNN(MyMyConfig conf, String string, Map<String, MarketData> marketdatamap, String title, int category, AbstractCategory[] categories, Pipeline[] datareaders, NeuralNetCommand neuralnetcommand) throws Exception {
