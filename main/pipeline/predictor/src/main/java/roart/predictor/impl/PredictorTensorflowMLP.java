...
public class PredictorTensorflowMLP extends TensorflowPredictor {
    ...
    public PredictorTensorflowMLP(IclijConfig conf, String string, String title, int category, SerialPipeline datareaders, NeuralNetCommand neuralnetcommand, Inmemory inmemory) throws Exception {
