...
public abstract class TensorflowPredictor extends Predictor {
    ...
    public TensorflowPredictor(IclijConfig conf, String string, String title, int category, NeuralNetCommand neuralnetcommand, SerialPipeline datareaders, Inmemory inmemory) {
