...
public abstract class TensorflowPredictor extends Predictor {
    ...
    public TensorflowPredictor(MyMyConfig conf, String string, int category, NeuralNetCommand neuralnetcommand, Map<String, MarketData> marketdatamap, AbstractCategory[] categories, Pipeline[] datareaders) {
