...
public class PredictorPytorchMLP extends PytorchPredictor {
    ...
    public PredictorPytorchMLP(IclijConfig conf, String string, String title, int category, PipelineData[] datareaders, NeuralNetCommand neuralnetcommand, Inmemory inmemory) throws Exception {
