...
public class PredictorPytorchMLP extends PytorchPredictor {
    ...
    public PredictorPytorchMLP(IclijConfig conf, String string, Map<String, MarketData> marketdatamap, String title, int category, AbstractCategory[] categories, Pipeline[] datareaders, NeuralNetCommand neuralnetcommand) throws Exception {
