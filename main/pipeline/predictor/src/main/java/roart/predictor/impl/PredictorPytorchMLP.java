...
public class PredictorPytorchMLP extends PytorchPredictor {
    ...
    public PredictorPytorchMLP(IclijConfig conf, String string, String title, int category, SerialPipeline datareaders, NeuralNetCommand neuralnetcommand, Inmemory inmemory) throws Exception {
