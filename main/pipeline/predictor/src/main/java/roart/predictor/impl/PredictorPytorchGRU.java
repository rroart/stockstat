...
public class PredictorPytorchGRU extends PytorchPredictor {
    ...
    public PredictorPytorchGRU(IclijConfig conf, String string, String title, int category, SerialPipeline datareaders, NeuralNetCommand neuralnetcommand, Inmemory inmemory) throws Exception {
