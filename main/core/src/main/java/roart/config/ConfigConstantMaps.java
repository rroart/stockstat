...
public class ConfigConstantMaps {
    ...
    public static void makeTypeMap() {
        ...
        map.put(ConfigConstants.MACHINELEARNINGTENSORFLOWLIR, Boolean.class);
        map.put(ConfigConstants.MACHINELEARNINGTENSORFLOWLIRPERSIST, Boolean.class);
        map.put(ConfigConstants.MACHINELEARNINGTENSORFLOWLIRCONFIG, String.class);
        ...
        map.put(ConfigConstants.MACHINELEARNINGTENSORFLOWPREDICTORLSTM, Boolean.class);
        map.put(ConfigConstants.MACHINELEARNINGTENSORFLOWPREDICTORLSTMPERSIST, Boolean.class);
        map.put(ConfigConstants.MACHINELEARNINGTENSORFLOWPREDICTORLSTMCONFIG, String.class);
    ...
    public static void makeTextMap() {
        ...
        text.put(ConfigConstants.MACHINELEARNINGTENSORFLOWLIR, "Enable Tensorflow LIR");
        text.put(ConfigConstants.MACHINELEARNINGTENSORFLOWLIRPERSIST, "Enable Tensorflow LIR persist");
        text.put(ConfigConstants.MACHINELEARNINGTENSORFLOWLIRCONFIG, "Config for Tensorflow LIR");
        text.put(ConfigConstants.MACHINELEARNINGTENSORFLOWPREDICTORLSTM, "Enable Tensorflow Predictor LSTM");
        text.put(ConfigConstants.MACHINELEARNINGTENSORFLOWPREDICTORLSTMPERSIST, "Enable Tensorflow Predictor LSTM persist");
        text.put(ConfigConstants.MACHINELEARNINGTENSORFLOWPREDICTORLSTMCONFIG, "Config for Tensorflow Predictor LSTM");
