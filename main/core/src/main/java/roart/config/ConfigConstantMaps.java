...
public class ConfigConstantMaps {
    ...
    private static final String SPARKLSVCCONFIG = "{ \"maxiter\" : 100, \"tol\" : 1.0E-6, \"fitintercept\" : false }";
	...
	deflt.put(ConfigConstants.MACHINELEARNINGSPARKMLSPARKNETWORKTIMEOUT, 300);
        ...
        deflt.put(ConfigConstants.MACHINELEARNINGTENSORFLOWLSTMCONFIG, TENSORFLOWPREDICTORLSTMCONFIG);
