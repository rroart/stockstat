...
public class ServiceUtil {
    ...
    public AbstractPredictor[] getPredictors(MyMyConfig conf, List<StockItem> stocks,
            String[] periodText,
            Map<String, MarketData> marketdatamap,
            Map<String, PeriodData> periodDataMap, List<StockItem>[] datedstocklists, Pipeline[] datareaders, AbstractCategory[] categories, NeuralNetCommand neuralnetcommand) throws Exception {
        ...
        for (int i = 0; i < Constants.ALLPERIODS; i++) {
            ...
            allpredictors.add(new PredictorTensorflowLIR(conf, categories[i].getTitle() + " LIR", marketdatamap, periodDataMap, categories[i].getTitle(), categories[i].getPeriod(), categories, datareaders, neuralnetcommand));
            allpredictors.add(new PredictorTensorflowMLP(conf, categories[i].getTitle() + " MLP", marketdatamap, periodDataMap, categories[i].getTitle(), categories[i].getPeriod(), categories, datareaders, neuralnetcommand));
            allpredictors.add(new PredictorTensorflowRNN(conf, categories[i].getTitle() + " RNN", marketdatamap, periodDataMap, categories[i].getTitle(), categories[i].getPeriod(), categories, datareaders, neuralnetcommand));
            allpredictors.add(new PredictorTensorflowLSTM(conf, categories[i].getTitle() + " LSTM", marketdatamap, periodDataMap, categories[i].getTitle(), categories[i].getPeriod(), categories, datareaders, neuralnetcommand));
            allpredictors.add(new PredictorTensorflowGRU(conf, categories[i].getTitle() + " GRU", marketdatamap, periodDataMap, categories[i].getTitle(), categories[i].getPeriod(), categories, datareaders, neuralnetcommand));
            allpredictors.add(new PredictorPytorchMLP(conf, categories[i].getTitle() + " MLP", marketdatamap, periodDataMap, categories[i].getTitle(), categories[i].getPeriod(), categories, datareaders, neuralnetcommand));
            allpredictors.add(new PredictorPytorchRNN(conf, categories[i].getTitle() + " RNN", marketdatamap, periodDataMap, categories[i].getTitle(), categories[i].getPeriod(), categories, datareaders, neuralnetcommand));
            allpredictors.add(new PredictorPytorchLSTM(conf, categories[i].getTitle() + " LSTM", marketdatamap, periodDataMap, categories[i].getTitle(), categories[i].getPeriod(), categories, datareaders, neuralnetcommand));
            allpredictors.add(new PredictorPytorchGRU(conf, categories[i].getTitle() + " GRU", marketdatamap, periodDataMap, categories[i].getTitle(), categories[i].getPeriod(), categories, datareaders, neuralnetcommand));
