...
public class AggregatorUtils {
    ...
    public Aggregator[] getAggregates(IclijConfig conf, PipelineData[] pipelineData,
        ...
        aggregates[4] = new MLRSI(conf, catName, catName, cat, idNameMap, pipelineData, neuralnetcommand, stockDates, inmemory);
        aggregates[5] = new MLATR(conf, catName, catName, cat, idNameMap, pipelineData, neuralnetcommand, stockDates, inmemory);
        aggregates[6] = new MLCCI(conf, catName, catName, cat, idNameMap, pipelineData, neuralnetcommand, stockDates, inmemory);
        aggregates[7] = new MLSTOCH(conf, catName, catName, cat, idNameMap, pipelineData, neuralnetcommand, stockDates, inmemory);
        aggregates[8] = new MLMulti(conf, catName, catName, cat, idNameMap, pipelineData, neuralnetcommand, stockDates, inmemory);
        aggregates[9] = new MLIndicator(conf, catName, catName, cat, pipelineData, neuralnetcommand, stockDates, inmemory);
