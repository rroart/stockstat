...
@Component({
  selector: 'evolvebar',
  templateUrl: './evolvebar.component.html',
  //styleUrls: ['./main.component.scss'],
  animations: [routeAnimations]
})
export class EvolvebarComponent implements OnInit, OnDestroy {
  ...
  resetMLMACD(event, props) {
    this.store.dispatch(new ActionSetconfigvaluemap([ 'aggregators.mlmacd.mlconfig', null ]));
  }
