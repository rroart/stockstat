...
import { MarketbarComponent } from './marketbar.component';
...
@Component({
  selector: 'iclijmarket',
  templateUrl: './iclijmarket.component.html',
  //styleUrls: ['./main.component.scss'],
  animations: [routeAnimations]
})
export class IclijMarketComponent implements OnInit, OnDestroy {
