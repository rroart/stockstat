...
public class MLATRChromosome extends ConfigMapChromosome {

    public MLATRChromosome(ComponentData param, ProfitData profitdata, List<String> confList, Market market, List<Integer> positions, String component, Boolean buy) {
    ...
    public AbstractChromosome copy() {
        ...
        MLATRChromosome chromosome = new MLATRChromosome(newparam, profitdata, confList, market, positions, componentName, buy);
