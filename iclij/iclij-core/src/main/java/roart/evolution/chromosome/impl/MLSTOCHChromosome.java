...
public class MLSTOCHChromosome extends ConfigMapChromosome {
    ...
    public AbstractChromosome copy() {
        ...
        MLSTOCHChromosome chromosome = new MLSTOCHChromosome(newparam, profitdata, confList, market, positions, componentName, buy);
