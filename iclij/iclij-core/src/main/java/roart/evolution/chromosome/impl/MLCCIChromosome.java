...
public class MLCCIChromosome extends ConfigMapChromosome {
    ...
    public AbstractChromosome copy() {
        ...
        MLCCIChromosome chromosome = new MLCCIChromosome(newparam, profitdata, confList, market, positions, componentName, buy);
