...
public class IclijConfigConstantMaps {
	...
	deflt.put(IclijConfigConstants.EVOLVEMLINDICATOREVOLUTIONCONFIG, null);
        ...
        deflt.put(IclijConfigConstants.EVOLVEPREDICTORMLCONFIG, MLCONFIGLSTM);
    ...
    public static void makeMap() {
        ...
        mymap.put(IclijConfigConstants.EVOLVEPREDICTORMLCONFIG, new IclijXMLType(String.class, MLCONFIGLSTM, "evolve predictor ml enable"));
