...
public abstract class ComponentMLCCI extends ComponentMLAggregator {
    ...
    protected ConfigMapChromosome getNewChromosome(MarketAction action, Market market, ProfitData profitdata,
        ...
        return new MLCCIChromosome(action, param, profitdata, market, positions, getPipeline(), buy, subcomponent, parameters, gene);
    }
