...
public class AboveBelowComponent extends ComponentML {
    ...
    public ComponentData handle(MarketAction action, Market market, ComponentData param, ProfitData profitdata,
	    ...
	    Double threshold = realParameters.getThreshold();
            ...
            double scoreFilter = 0;
            {
                ...
                action.getListComponents(myData, param, null, realParameters, evolve, market, null, listComponent2, olddate, prevDate);
    ...
    private void getListComponentsNew(WebData myData, ComponentData param, Parameters parameters,
            ...
            LocalDate olddate, List<IncDecItem> mylocals, MarketAction action) {
    ...
    private void filterMemoryListMapsWithConfidenceNew(Market market, Map<Triple<String, String, String>, List<IncDecItem>> listMap, ComponentData param, Parameters parameters, MarketAction action) {
