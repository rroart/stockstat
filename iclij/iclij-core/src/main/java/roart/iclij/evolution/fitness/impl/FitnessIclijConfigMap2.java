...
public class FitnessIclijConfigMap2 {
    ...
    public FitnessIclijConfigMap2(MarketAction action, ComponentData param, ProfitData profitdata, Market market, Memories positions, String componentName, Boolean buy, String subcomponent, Parameters parameters, IclijConfigMapGene gene, List<String> stockDates) {
        this.action = action;
        this.param = param;
    ...
    public synchronized double fitness(IclijConfigMapChromosome chromosome) {
        IclijConfigMapGene gene = ((IclijConfigMapChromosome) chromosome).gene();
        ...
        IclijConfigMapGene gene2 = ((IclijConfigMapChromosome) chromosome).gene();
