...
public class FitnessAboveBelowCommon {
    ...
    public double fitnessCommon(List<Boolean> genes, MarketAction action, ComponentData param, ProfitData profitdata, List<String> components, List<String> subcomponents, List<IncDecItem> incdecs, Market market, List<String> stockDates, Parameters parameters, Boolean buy, String componentName, Map<String, Object> map) {
