...
public class FitnessMarketFilterCommon {
    ...
    public double fitnessCommon(MarketAction action, ComponentData param, Market market, ProfitData profitdata, Boolean buy, List<String> stockDates, List<IncDecItem> incdecs, Parameters parameters, String componentName, Map<String, Object> map) {
