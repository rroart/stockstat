...
#STEPS=100
    ...
    GEMCONFIG[3]="\"gemMMConfig\" : { \"name\" : \"multimodal\", \"steps\" : $STEPS, \"n_layers\" : 1, \"n_hiddens\" : 100, \"lr\" : 0.001, \"data_file\" : \"\" }"
    ...
    GEMCONFIG[6]="\"gemiCaRLConfig\" : { \"name\" : \"iCaRL\", \"steps\" : $STEPS, \"n_layers\" : 2, \"n_hiddens\" : 100, \"lr\" : 0.001, \"n_memories\" : 1280, \"memory_strength\" : 1, \"samples_per_task\" : 10, \"data_file\" : \"\" }"
    FILENAME[1]=\"s\"
    FILENAME[2]=\"i\"
    FILENAME[3]=\"m\"
    FILENAME[4]=\"e\"
    ...
    PYTORCHCONFIG[1]="\"pytorchMLPConfig\" : { \"name\" : \"mlp\", \"steps\" : $STEPS, \"hidden\" : 20, \"layers\":3, \"lr\" : 0.01 }"
    ...
    TENSORFLOWCONFIG[1]="\"tensorflowDNNConfig\" : { \"name\" : \"dnn\", \"steps\" : $STEPS, \"hiddenneurons\" : 20, \"hiddenlayers\":3 }"
    TENSORFLOWCONFIG[2]="\"tensorflowLICConfig\" : { \"name\" : \"lic\", \"steps\" : $STEPS }"
    TENSORFLOWCONFIG[3]="\"tensorflowMLPConfig\" : { \"name\" : \"mlp\", \"steps\" : $STEPS, \"hiddenneurons\" : 20, \"hiddenlayers\" : 3, \"lr\" : 0.01 }"
    TENSORFLOWCONFIG[4]="\"tensorflowRNNConfig\" : { \"name\" : \"rnn\", \"steps\" : $STEPS, \"hiddenneurons\" : 100, \"hiddenlayers\" : 2, \"lr\" : 0.01, \"dropout\" : 0, \"dropoutin\" : 0 }"
    TENSORFLOWCONFIG[5]="\"tensorflowCNNConfig\" : { \"name\" : \"cnn\", \"steps\" : $STEPS, \"stride\" : 1, \"kernelsize\" : 4, \"dropout\" : 0.5 }"
    TENSORFLOWCONFIG[6]="\"tensorflowLSTMConfig\" : { \"name\" : \"lstm\", \"steps\" : $STEPS, \"hiddenneurons\" : 100, \"hiddenlayers\" : 2, \"lr\" : 0.01, \"dropout\" : 0, \"dropoutin\" : 0 }"
    TENSORFLOWCONFIG[7]="\"tensorflowGRUConfig\" : { \"name\" : \"gru\", \"steps\" : $STEPS, \"hiddenneurons\" : 100, \"hiddenlayers\" : 2, \"lr\" : 0.01, \"dropout\" : 0, \"dropoutin\" : 0 }"
