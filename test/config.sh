    ...
    TENSORFLOWCONFIG[4]="\"tensorflowRNNConfig\" : { \"name\" : \"rnn\", \"steps\" : 100, \"hiddenneurons\" : 100, \"hiddenlayers\" : 2, \"lr\" : 0.001, \"dropout\" : 0, \"dropoutin\" : 0 }"
    TENSORFLOWCONFIG[5]="\"tensorflowCNNConfig\" : { \"name\" : \"cnn\", \"steps\" : 100, \"stride\" : 1, \"kernelsize\" : 4, \"dropout\" : 0.5 }"
    TENSORFLOWCONFIG[6]="\"tensorflowLSTMConfig\" : { \"name\" : \"lstm\", \"steps\" : 100, \"hiddenneurons\" : 100, \"hiddenlayers\" : 2, \"lr\" : 0.001, \"dropout\" : 0, \"dropoutin\" : 0 }"
    TENSORFLOWCONFIG[7]="\"tensorflowGRUConfig\" : { \"name\" : \"gru\", \"steps\" : 100, \"hiddenneurons\" : 100, \"hiddenlayers\" : 2, \"lr\" : 0.001, \"dropout\" : 0, \"dropoutin\" : 0 }"
