...
#STEPS=100
    ...
    TENSORFLOWCONFIG[1]="\"tensorflowDNNConfig\" : { \"name\" : \"dnn\", \"steps\" : $STEPS, \"hidden\" : 20, \"layers\":3 }"
    TENSORFLOWCONFIG[2]="\"tensorflowLICConfig\" : { \"name\" : \"lic\", \"steps\" : $STEPS }"
    TENSORFLOWCONFIG[3]="\"tensorflowMLPConfig\" : { \"name\" : \"mlp\", \"steps\" : $STEPS, \"hidden\" : 20, \"layers\" : 3, \"lr\" : 0.01 }"
